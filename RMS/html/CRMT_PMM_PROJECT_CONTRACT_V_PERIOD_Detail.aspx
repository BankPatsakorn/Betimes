<%@ Page Title="" UICulture="th" Culture="th-TH" Language="C#" MasterPageFile="~/Master/bs.master" AutoEventWireup="true" CodeFile="CRMT_PMM_PROJECT_CONTRACT_V_PERIOD_Detail.aspx.cs" Inherits="CRMT_PMM_PROJECT_CONTRACT_V_PERIOD_Detail" %>
...
<asp:SqlDataSource ID="dsCRMT_PMM_PROJECT_CONTRACT_V_PERIOD_Detail" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" 
...
from CRMT_PMM_PROJECT_CONTRACT_V_PERIOD 
where  1=1  AND FALSE=@FALSE AND TRUE=@TRUE" 
            InsertCommand="insert into CRMT_PMM_PROJECT_CONTRACT_V_PERIOD
(
PERIOD_DateTime
,PERIOD_AMOUNT
,PERIOD_PERCENT
...
,@PERIOD_STATUS
            ...
            UpdateCommand="update CRMT_PMM_PROJECT_CONTRACT_V_PERIOD 
set 
...
<SelectParameters>
<asp:Parameter Name="FALSE" Type="Int32" /><asp:Parameter Name="TRUE" Type="Int32" />
</SelectParameters>
             </asp:SqlDataSource>
