<%@ Page Title="" UICulture="th" Culture="th-TH" Language="C#" MasterPageFile="~/Master/bs.master" AutoEventWireup="true" CodeFile="CRMT_PMM_PROJECT_CONTRACT_V_BORAD_Detail.aspx.cs" Inherits="CRMT_PMM_PROJECT_CONTRACT_V_BORAD_Detail" %>
...
<div ID="PERSONAL_ID" class="form-group col-sm-12">
    ...
    runat="server" Width="0"></dx:ASPxTextBox>
            <span class="input-group-btn">
                  <button id="btnPERSONAL_ID" class="btn btn-primary" 
                     onclick="OpenLku('lkuPERSONAL_ID', 'PERSONAL_ID.aspx', 'ctlPERSONAL_ID', 'ctlPERSONAL_ID_label')"  type="button"><span class="glyphicon glyphicon-search"></span></button>
            </span>
        </div>
    </div>
</div>
...
<asp:SqlDataSource ID="dsCRMT_PMM_PROJECT_CONTRACT_V_BORAD_Detail" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" 
...
where  1=1  AND VIEW_COMMON_MASTER_PERSONAL.PERSONAL_ID=@PERSONAL_ID" 
            InsertCommand="insert into CRMT_PMM_PROJECT_CONTRACT_V_BORAD
(
BORAD_POSITION
)
values
