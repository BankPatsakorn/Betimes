<%@ Page Title="" UICulture="th" Culture="th-TH" Language="C#" MasterPageFile="~/Master/bs.master" AutoEventWireup="true" CodeFile="CRMT_PMM_PROJECT_CONTRACT_PERIOD_DET_List.aspx.cs" Inherits="CRMT_PMM_PROJECT_CONTRACT_PERIOD_DET_List" %>
...
<div>
<input type="button" class='btn btn-primary' value=' Add ' onclick="location='CRMT_PMM_PROJECT_CONTRACT_PERIOD_DET_Detail.aspx?id=-1';" />
</div>
<div>
<div>
...
<asp:SqlDataSource ID="dsCRMT_PMM_PROJECT_CONTRACT_PERIOD_DET_List" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" 
            ...
            SelectCommand="select CRMT_PMM_PROJECT_CONTRACT_PERIOD_DET.PERIOD_DET_NO
...
,CRMT_PMM_PROJECT_CONTRACT_PERIOD_DET.PERIOD_DET_REMARK
 from CRMT_PMM_PROJECT_CONTRACT_PERIOD_DET where  1=1 " >
            <DeleteParameters>
