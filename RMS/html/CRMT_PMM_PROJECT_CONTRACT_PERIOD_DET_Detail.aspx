<%@ Page Title="" UICulture="th" Culture="th-TH" Language="C#" MasterPageFile="~/Master/bs.master" AutoEventWireup="true" CodeFile="CRMT_PMM_PROJECT_CONTRACT_PERIOD_DET_Detail.aspx.cs" Inherits="CRMT_PMM_PROJECT_CONTRACT_PERIOD_DET_Detail" %>
...
<asp:SqlDataSource ID="dsCRMT_PMM_PROJECT_CONTRACT_PERIOD_DET_Detail" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" 
...
from CRMT_PMM_PROJECT_CONTRACT_PERIOD_DET 
where  1=1  AND CRMT_PMM_PROJECT_CONTRACT_PERIOD_DET.PERIOD_DET_ID=@PERIOD_DET_ID" 
            InsertCommand="insert into CRMT_PMM_PROJECT_CONTRACT_PERIOD_DET
(
PERIOD_DET_DESC
,PERIOD_DET_QUANTITY
,UNIT_ID
...
,@PERIOD_DET_REMARK
            ...
            UpdateCommand="update CRMT_PMM_PROJECT_CONTRACT_PERIOD_DET 
set 
...
where  1=1 
 AND PERIOD_DET_ID=@PERIOD_DET_ID" 
            >
            <DeleteParameters>
