<%@ Page Title="" UICulture="th" Culture="th-TH" Language="C#" MasterPageFile="~/Master/bs.master" AutoEventWireup="true" CodeFile="RMSM_RMM_MEETING_AGENDA_DETAIL_DOC_DetailView.aspx.cs" Inherits="RMSM_RMM_MEETING_AGENDA_DETAIL_DOC_DetailView" %>
...
<asp:SqlDataSource ID="dsRMSM_RMM_MEETING_AGENDA_DETAIL_DOC_DetailView" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" 
            DeleteCommand="DELETE FROM RMSM_RMM_MEETING_AGENDA_DETAIL_DOC WHERE [AGENDA_DETAIL_DOC] = @AGENDA_DETAIL_DOC" 
            SelectCommand="select 
RMSM_RMM_MEETING_AGENDA_DETAIL_DOC.AGENDA_DETAIL_DOC
,RMSM_RMM_MEETING_AGENDA_DETAIL_DOC.DOC_TAG
,RMSM_RMM_MEETING_AGENDA_DETAIL_DOC.DOC_LOGICAL_NAME
,RMSM_RMM_MEETING_AGENDA_DETAIL_DOC.DOC_IMPORT_DATE
,RMSM_RMM_MEETING_AGENDA_DETAIL_DOC.DOC_TYPE_ID
 
from RMSM_RMM_MEETING_AGENDA_DETAIL_DOC 
left join [OPM_COMMON_DATA].[dbo].COMM_MDM_DOC_TYPE_INFO on RMSM_RMM_MEETING_AGENDA_DETAIL_DOC.DOC_TYPE_ID = COMM_MDM_DOC_TYPE_INFO.DOC_TYPE_ID  
where  1=1  AND RMSM_RMM_MEETING_AGENDA_DETAIL_DOC.AGENDA_DETAIL_DOC=@AGENDA_DETAIL_DOC" 
            InsertCommand="insert into RMSM_RMM_MEETING_AGENDA_DETAIL_DOC
(
DOC_TAG
,DOC_LOGICAL_NAME
,DOC_IMPORT_DATE
...
,@DOC_TYPE_ID
            ...
            UpdateCommand="update RMSM_RMM_MEETING_AGENDA_DETAIL_DOC 
set 
DOC_TAG=@DOC_TAG
...
where  1=1 
 AND AGENDA_DETAIL_DOC=@AGENDA_DETAIL_DOC" 
            >
            <DeleteParameters>
