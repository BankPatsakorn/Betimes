<%@ Page Title="" UICulture="th" Culture="th-TH" Language="C#" MasterPageFile="~/Master/bs.master" AutoEventWireup="true" CodeFile="RMSM_MDM_MENU_INFO_DetailView.aspx.cs" Inherits="RMSM_MDM_MENU_INFO_DetailView" %>
...
<div ID="MENU_NAME" class="form-group col-sm-12">
                    <label for="" class="col-sm-4 control-label">เมนู:</label>
                    <div class="col-sm-8">
<dx:ASPxTextBox ID="ctlMENU_NAME" runat="server" Height="30" Width="800"></dx:ASPxTextBox>
                        </div>
    </div>
</div><!--end col 21-->
</div><!--end row 22-->
...
<asp:SqlDataSource ID="dsRMSM_MDM_MENU_INFO_DetailView" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" 
            DeleteCommand="" 
            SelectCommand="SELECT [MENU_NAME]
