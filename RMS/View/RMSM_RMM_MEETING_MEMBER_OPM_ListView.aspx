<%@ Page Title="" UICulture="th" Culture="th-TH" Language="C#" MasterPageFile="~/Master/bs.master" AutoEventWireup="true" CodeFile="RMSM_RMM_MEETING_MEMBER_OPM_ListView.aspx.cs" Inherits="RMSM_RMM_MEETING_MEMBER_OPM_ListView" %>
...
<div>
<input type="button" class='btn btn-primary' value=' Add ' onclick="location='RMSM_RMM_MEETING_MEMBER_OPM_DetailView.aspx?id=-1';" />
</div>
<div>
<div>


<dx:ASPxGridView ID="viewRMSM_RMM_MEETING_MEMBER_OPM_ListView" runat="server" Width="100%" 
AutoGenerateColumns="False" Styles-AlternatingRow-BackColor="White" Styles-Row-BackColor="#D9EDF7"
DataSourceID="dsRMSM_RMM_MEETING_MEMBER_OPM_ListView" KeyFieldName="MEETING_MEMBER_ID"  ClientInstanceName="viewRMSM_RMM_MEETING_MEMBER_OPM_ListView" Theme="Metropolis">
            <Columns>

            <dx:GridViewCommandColumn SelectAllCheckboxMode="Page" ShowClearFilterButton="True" 
ShowDeleteButton="True" ShowSelectCheckbox="False" ButtonType="Image" VisibleIndex="0" Caption="delete">
            </dx:GridViewCommandColumn>
            <dx:GridViewDataTextColumn FieldName="MEETING_MEMBER_ID" ReadOnly="True"  Visible="False" VisibleIndex="2">
                    <EditFormSettings Visible="False" />
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn VisibleIndex="1" Caption="edit">
                <DataItemTemplate>
                    <a target="_self" href="RMSM_RMM_MEETING_MEMBER_OPM_DetailView.aspx?MEETING_MEMBER_ID=<%#Eval("MEETING_MEMBER_ID") %>"><img src="images/edit.png" style="border:none" alt="edit" /></a>
                </DataItemTemplate>
            </dx:GridViewDataTextColumn>
...
<a id="fancyBoxRMSM_RMM_MEETING_MEMBER_OPM_ListView" class='fancyBox'  style="display:none"></a>

</div>
</div>
<div>

<asp:SqlDataSource ID="dsRMSM_RMM_MEETING_MEMBER_OPM_ListView" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" 
...
,[dbo].[RMSM_RMM_MEETING_MEMBER].MEETING_MEMBER_STATUS
