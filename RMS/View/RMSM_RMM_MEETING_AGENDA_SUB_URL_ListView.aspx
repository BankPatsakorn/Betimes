<%@ Page Title="" UICulture="th" Culture="th-TH" Language="C#" MasterPageFile="~/Master/bs.master" AutoEventWireup="true" CodeFile="RMSM_RMM_MEETING_AGENDA_SUB_URL_ListView.aspx.cs" Inherits="RMSM_RMM_MEETING_AGENDA_SUB_URL_ListView" %>
...
<div>
<input type="button" class='btn btn-primary' value=' เพิ่ม ' onclick="location='RMSM_RMM_MEETING_AGENDA_SUB_URL_DetailView.aspx?id=-1';" />
</div>
<div>
<div>
...
ShowDeleteButton="True" ShowSelectCheckbox="False" ButtonType="Image" VisibleIndex="0">
            ...
            <dx:GridViewDataTextColumn VisibleIndex="1" Caption="">
                <DataItemTemplate>
                    <a target="_self" href="RMSM_RMM_MEETING_AGENDA_SUB_URL_DetailView.aspx?AGENDA_SUB_URL_ID=<%#Eval("AGENDA_SUB_URL_ID") %>"><img src="images/edit.png" style="border:none" alt="edit" /></a>
                </DataItemTemplate>
            </dx:GridViewDataTextColumn>
