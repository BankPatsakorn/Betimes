<%@ Page Title="" UICulture="th" Culture="th-TH" Language="C#" MasterPageFile="~/Master/bs.master" AutoEventWireup="true" CodeFile="RMSM_RMM_MEETING_EQUIPMENT_DetailView.aspx.cs" Inherits="RMSM_RMM_MEETING_EQUIPMENT_DetailView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="form-group col-sm-12" style="margin-top: 50px;">
        <div class="col-sm-offset-10 col-sm-6">
            ...
            <asp:Button ID="btnBack" runat="server" Text="ย้อนกลับ" CssClass="btn btn-warning btn-80" OnClick="btnBack_Click" />
    ...
    <div class="col-sm-12">
        <div class="row">
            ...
            <div class="col-sm-6">
                <!--col 19-->
                <div id="EQUIPMENT_ID" class="form-group col-sm-12">
                    <label for="" class="col-sm-4 control-label">อุปกรณ์:</label>
                    <div class="col-sm-8">
                        <dx:ASPxComboBox
                            ID="ctlEQUIPMENT_ID" runat="server"
                            DropDownStyle="DropDown" Height="30"
                            DataSourceID="dsRMSM_MDM_EQUIPMENT_INFO"
                            TextField="EQUIPMENT_NAME" ValueField="EQUIPMENT_ID"
                ...
                <div id="EQUIPMENT_AMOUNT" class="form-group col-sm-12">
                    ...
                    <div class="col-sm-8">
                        <dx:ASPxSpinEdit ID="ctlEQUIPMENT_AMOUNT" runat="server" Height="30" Width="100%">
                            <SpinButtons ShowIncrementButtons="false"></SpinButtons>
                        </dx:ASPxSpinEdit>
                    </div>
                </div>
                <div id="COUNT_UNIT_NAME" class="form-group col-sm-12">
                    <label for="" class="col-sm-4 control-label">หน่วยนับ:</label>
                    <div class="col-sm-8">
                        <dx:ASPxTextBox ID="ctlCOUNT_UNIT_NAME" Enabled="False" Height="30" ForeColor="#000000" BackColor="#DDDDDD" runat="server" Width="100%"></dx:ASPxTextBox>
                    </div>
                </div>
            </div>
            <!--end col 23-->
    ...
    <div>
        ...
        <asp:SqlDataSource ID="dsRMSM_RMM_MEETING_EQUIPMENT_DetailView" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>"
            DeleteCommand=""
            SelectCommand="SELECT RMSM_RMM_MEETING_EQUIPMENT.EQUIPMENT_ID 
...
WHERE MEETING_EQUIPMENT_ID = @MEETING_EQUIPMENT_ID"
            InsertCommand=""
            UpdateCommand="">
            <DeleteParameters>
        ...
        <asp:SqlDataSource ID="dsCOMM_MDM_COUNT_UNIT_INFO" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>"
            SelectCommand="select COUNT_UNIT_NAME,COUNT_UNIT_ID from COMM_MDM_COUNT_UNIT_INFO"></asp:SqlDataSource>

        <asp:SqlDataSource ID="dsRMSM_MDM_EQUIPMENT_INFO" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>"
            SelectCommand="select EQUIPMENT_NAME,EQUIPMENT_ID from RMSM_MDM_EQUIPMENT_INFO"></asp:SqlDataSource>
