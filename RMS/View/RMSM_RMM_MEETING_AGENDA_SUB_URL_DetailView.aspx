<%@ Page Title="" UICulture="th" Culture="th-TH" Language="C#" MasterPageFile="~/Master/bs.master" AutoEventWireup="true" CodeFile="RMSM_RMM_MEETING_AGENDA_SUB_URL_DetailView.aspx.cs" Inherits="RMSM_RMM_MEETING_AGENDA_SUB_URL_DetailView" %>
...
<asp:SqlDataSource ID="dsRMSM_RMM_MEETING_AGENDA_SUB_URL_DetailView" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" 
            DeleteCommand="DELETE FROM RMSM_RMM_MEETING_AGENDA_SUB_URL WHERE [AGENDA_SUB_URL_ID] = @AGENDA_SUB_URL_ID" 
            SelectCommand="select 
RMSM_RMM_MEETING_AGENDA_SUB_URL.AGENDA_SUB_URL_ID
,RMSM_RMM_MEETING_AGENDA_SUB_URL.URL_LINK
,RMSM_RMM_MEETING_AGENDA_SUB_URL.CREATE_DATE
 
from RMSM_RMM_MEETING_AGENDA_SUB_URL 
where  1=1  AND RMSM_RMM_MEETING_AGENDA_SUB_URL.AGENDA_SUB_URL_ID=@AGENDA_SUB_URL_ID" 
            InsertCommand="insert into RMSM_RMM_MEETING_AGENDA_SUB_URL
(
URL_LINK
,CREATE_DATE
)
...
,@CREATE_DATE
            ...
            UpdateCommand="update RMSM_RMM_MEETING_AGENDA_SUB_URL 
set 
URL_LINK=@URL_LINK
,CREATE_DATE=@CREATE_DATE
 
where  1=1 
 AND AGENDA_SUB_URL_ID=@AGENDA_SUB_URL_ID" 
            >
            <DeleteParameters>
