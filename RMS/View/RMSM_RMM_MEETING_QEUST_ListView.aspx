<%@ Page Title="" UICulture="th" Culture="th-TH" Language="C#" MasterPageFile="~/Master/bs.master" AutoEventWireup="true" CodeFile="RMSM_RMM_MEETING_QEUST_ListView.aspx.cs" Inherits="RMSM_RMM_MEETING_QEUST_ListView" %>
...
<div>
<input type="button" class='btn btn-primary' value=' เพิ่ม ' onclick="location='RMSM_RMM_MEETING_QEUST_DetailView.aspx?id=-1';" />
</div>
<div>
<div>


<dx:ASPxGridView ID="viewRMSM_RMM_MEETING_QEUST_ListView" runat="server" Width="100%" 
AutoGenerateColumns="False" Styles-AlternatingRow-BackColor="White" Styles-Row-BackColor="#D9EDF7"
DataSourceID="dsRMSM_RMM_MEETING_QEUST_ListView" KeyFieldName="MEETING_ID"  ClientInstanceName="viewRMSM_RMM_MEETING_QEUST_ListView" Theme="Metropolis">
            <Columns>
...
ShowDeleteButton="True" ShowSelectCheckbox="False" ButtonType="Image" VisibleIndex="0">
            ...
            <dx:GridViewDataTextColumn VisibleIndex="1" Caption="">
                <DataItemTemplate>
                    <a target="_self" href="RMSM_RMM_MEETING_QEUST_DetailView.aspx?MEETING_ID=<%#Eval("MEETING_ID") %>"><img src="images/edit.png" style="border:none" alt="edit" /></a>
                </DataItemTemplate>
            </dx:GridViewDataTextColumn>
...
<a id="fancyBoxRMSM_RMM_MEETING_QEUST_ListView" class='fancyBox'  style="display:none"></a>

</div>
</div>
<div>

<asp:SqlDataSource ID="dsRMSM_RMM_MEETING_QEUST_ListView" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" 
