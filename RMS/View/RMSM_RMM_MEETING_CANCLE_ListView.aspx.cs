...
public partial class RMSM_RMM_MEETING_CANCLE_ListView : System.Web.UI.Page
{
	public string JS="";
...
string inputMEETING_ID="-1";
    ...
    {
        //
//Grid RMSM_RMM_MEETING_CANCLE_ListView 
dsRMSM_RMM_MEETING_CANCLE_ListView.SelectParameters.Clear();
        if (Request.QueryString["MEETING_ID"] != null && Request.QueryString["MEETING_ID"] != "-1")
        {
            inputMEETING_ID = Request.QueryString["MEETING_ID"];
        }
dsRMSM_RMM_MEETING_CANCLE_ListView.SelectParameters.Add("MEETING_ID", System.Data.DbType.Int32, inputMEETING_ID);
