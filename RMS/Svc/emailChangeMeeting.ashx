<%@ WebHandler Language="C#" Class="emailChangeMeeting" %>

using System;
using System.Web;
using System.Net.Mail;
using System.Data;
public class emailChangeMeeting : IHttpHandler {
    
    public void ProcessRequest (HttpContext context) {
        //FnSendMail();
        context.Response.ContentType = "text/plain";
        context.Response.Write("ส่ง Email การเลื่อนการประชุมถึงผู้เข้าร่วมประชุมแล้ว");
    }
